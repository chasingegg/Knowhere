...
class Pack : public Object {
    ...
    static_assert(std::is_same_v<T, std::shared_ptr<knowhere::FileManager>> || std::is_same_v<T, knowhere::ViewDataOp> || std::is_same_v<T, std::shared_ptr<milvus::FileManager>>,
