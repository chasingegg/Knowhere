 ...
 * direct copy. Bit-packed document-ID gaps and TF values both use ordinary SIMD unpacking; the posting cursor keeps
 * document-ID gaps lazy and accumulates them only while advancing. A logical block still carries one outer encoding
 * tag.
 *
 * Block layout:
 *   byte 0      : encoding tag
